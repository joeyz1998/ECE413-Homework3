...
classdef objChord
    ...
    methods
        function obj = objChord(varargin)
            ...
            obj.totalDuration = obj.noteDuration + obj.breathDuration;
            ...
            for cnt=1:(length(offsets)+1)
                obj.arrayNotes(cnt)=objNote(currentNoteNumber,obj.temperament,obj.key,startTime,endTime,amplitudeNote,inst);
