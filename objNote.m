...
classdef objNote
    ...
    properties (Constant = true, GetAccess = private)
        % Constants
        refFreq           = 220       % Reference to 440 Hz
    ...
    methods
        function obj = objNote(noteNumber,temperament,key,startTime,endTime,amplitude,inst)
            if nargin >= 5
